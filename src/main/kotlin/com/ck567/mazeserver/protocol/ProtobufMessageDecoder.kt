...
import com.ck567.mazeserver.message.ProtobufOpreateType
...
class ProtobufMessageDecoder : MessageToMessageDecoder<WebSocketFrame>() {
    ...
    override fun decode(ctx: ChannelHandlerContext, msg: WebSocketFrame, out: MutableList<Any>) {
        ...
        buf.readBytes(data)
        // 编解码器的分发
        val serialization = ProtobufOpreateType.getSerializer(type)
